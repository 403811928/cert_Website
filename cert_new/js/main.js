    		...
    		if (window.console && console.log) {
        		...
        		if (delta == -1) {
        			...
        			if (left >=-((itemLength-1) * 231) ) {
        				$(".teamBoxes").attr("style","left:"+parseInt(left - 231)+"px;");//设置left值
        			}
        			...
        			if( left <= 0 ){
        				...
        				for(var i = 0;i < itemLength; i++){
        						...
        						$(".teamBoxes").attr("style","left:"+parseInt(left + 231)+"px;");
        				}
        			}		

        		}
        		console.log(delta, deltaX, deltaY,"a="+a,"m=:"+m);
    		}
	});
